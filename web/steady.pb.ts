...
export interface CreateServiceVersionResponse {
...
export async function CreateServiceVersion(
  createServiceVersionRequest: CreateServiceVersionRequest,
  config?: ClientConfiguration
): Promise<CreateServiceVersionResponse> {
  const response = await PBrequest(
...
export interface Steady<Context = unknown> {
  ...
  CreateService: (
    createServiceRequest: CreateServiceRequest,
    context: Context
  ) => Promise<CreateServiceResponse> | CreateServiceResponse;
  CreateServiceVersion: (
    createServiceVersionRequest: CreateServiceVersionRequest,
    context: Context
  ) => Promise<CreateServiceVersionResponse> | CreateServiceVersionResponse;
  RunApplication: (
    runApplicationRequest: RunApplicationRequest,
    context: Context
...
export const CreateServiceRequest = {
   ...
   */
  encode: function (msg: Partial<CreateServiceRequest>): Uint8Array {
   ...
   */
  decode: function (bytes: ByteSource): CreateServiceRequest {
   ...
   */
  initialize: function (): CreateServiceRequest {
    return {
      name: "",
    };
  },
   ...
   */
  _writeMessage: function (
    msg: Partial<CreateServiceRequest>,
    writer: BinaryWriter
  ): BinaryWriter {
    if (msg.name) {
...
export const CreateServiceResponse = {
   ...
   */
  encode: function (msg: Partial<CreateServiceResponse>): Uint8Array {
   ...
   */
  decode: function (bytes: ByteSource): CreateServiceResponse {
   ...
   */
  initialize: function (): CreateServiceResponse {
    return {
   ...
   */
  _writeMessage: function (
    msg: Partial<CreateServiceResponse>,
    writer: BinaryWriter
  ): BinaryWriter {
    if (msg.service) {
...
export const Service = {
   ...
   */
  encode: function (msg: Partial<Service>): Uint8Array {
   ...
   */
  decode: function (bytes: ByteSource): Service {
  ...
  _writeMessage: function (
    ...
    if (msg.id) {
      writer.writeInt64String(2, msg.id.toString() as any);
    }
    if (msg.userId) {
   ...
   * @private
   */
  _readMessage: function (msg: Service, reader: BinaryReader): Service {
    while (reader.nextField()) {
      const field = reader.getFieldNumber();
      switch (field) {
        case 1: {
...
export const CreateServiceVersionRequest = {
   ...
   */
  encode: function (msg: Partial<CreateServiceVersionRequest>): Uint8Array {
   ...
   */
  decode: function (bytes: ByteSource): CreateServiceVersionRequest {
   ...
   */
  initialize: function (): CreateServiceVersionRequest {
    return {
      serviceId: 0n,
      version: "",
      source: "",
   ...
   */
  _writeMessage: function (
    msg: Partial<CreateServiceVersionRequest>,
    writer: BinaryWriter
  ): BinaryWriter {
    if (msg.serviceId) {
      writer.writeInt64String(1, msg.serviceId.toString() as any);
    }
    if (msg.version) {
   ...
   */
  _readMessage: function (
    msg: CreateServiceVersionRequest,
    reader: BinaryReader
...
export const CreateServiceVersionResponse = {
   ...
   */
  encode: function (msg: Partial<CreateServiceVersionResponse>): Uint8Array {
   ...
   */
  decode: function (bytes: ByteSource): CreateServiceVersionResponse {
   ...
   */
  initialize: function (): CreateServiceVersionResponse {
    return {
   ...
   */
  _writeMessage: function (
    msg: Partial<CreateServiceVersionResponse>,
    writer: BinaryWriter
  ): BinaryWriter {
   ...
   */
  _readMessage: function (
    msg: CreateServiceVersionResponse,
    reader: BinaryReader
...
export const ServiceVersion = {
   ...
   */
  encode: function (msg: Partial<ServiceVersion>): Uint8Array {
   ...
   */
  decode: function (bytes: ByteSource): ServiceVersion {
   ...
   */
  initialize: function (): ServiceVersion {
    return {
      id: 0n,
      serviceId: 0n,
      version: "",
  ...
  _writeMessage: function (
    ...
    if (msg.serviceId) {
      writer.writeInt64String(2, msg.serviceId.toString() as any);
    }
    if (msg.version) {
...
export const RunApplicationRequest = {
  ...
  _writeMessage: function (
    ...
    if (msg.serviceVersionId != undefined) {
      writer.writeInt64String(1, msg.serviceVersionId.toString() as any);
    }
...
export const CreateServiceRequestJSON = {
   ...
   */
  encode: function (msg: Partial<CreateServiceRequest>): string {
   ...
   */
  decode: function (json: string): CreateServiceRequest {
...
export const CreateServiceResponseJSON = {
   ...
   */
  encode: function (msg: Partial<CreateServiceResponse>): string {
   ...
   */
  decode: function (json: string): CreateServiceResponse {
...
export const ServiceJSON = {
   ...
   */
  encode: function (msg: Partial<Service>): string {
   ...
   */
  decode: function (json: string): Service {
   ...
   * @private
   */
  _writeMessage: function (msg: Partial<Service>): Record<string, unknown> {
    const json: Record<string, unknown> = {};
    if (msg.name) {
      json["name"] = msg.name;
    }
   ...
   * @private
   */
  _readMessage: function (msg: Service, json: any): Service {
    const _name_ = json["name"];
    if (_name_) {
      msg.name = _name_;
    }
...
export const CreateServiceVersionRequestJSON = {
   ...
   */
  encode: function (msg: Partial<CreateServiceVersionRequest>): string {
   ...
   */
  decode: function (json: string): CreateServiceVersionRequest {
...
export const CreateServiceVersionResponseJSON = {
   ...
   */
  encode: function (msg: Partial<CreateServiceVersionResponse>): string {
   ...
   */
  decode: function (json: string): CreateServiceVersionResponse {
...
export const ServiceVersionJSON = {
   ...
   */
  encode: function (msg: Partial<ServiceVersion>): string {
   ...
   */
  decode: function (json: string): ServiceVersion {
   ...
   * @private
   */
  _readMessage: function (msg: ServiceVersion, json: any): ServiceVersion {
    const _id_ = json["id"];
    if (_id_) {
      msg.id = BigInt(_id_);
    }
